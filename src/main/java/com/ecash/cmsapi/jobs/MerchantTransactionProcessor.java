...
public class MerchantTransactionProcessor implements ItemProcessor<TransactionVO, MerchantStatementVO>
{
  private static final Logger LOG = LoggerFactory.getLogger(MerchantTransactionProcessor.class);
  ...
  public MerchantStatementVO process(TransactionVO transaction) throws Exception
  {
    ...
    LOG.info("Creating cardStatement: {}", merchantStatementVO.toString());
